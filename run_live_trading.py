...
def start_live_trading(config_file="config_live.json", dry_run=True):
    ...
    cmd = [
        ...
        "trade",
        "--logfile", "logs/freqtrade_live.log",
        "--db-url", "sqlite:///tradesv3_live.sqlite",
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Start Freqtrade live trading with the Lorentzian ANN strategy')
    parser.add_argument('--config', type=str, default='config_live.json', help='Path to config file')
    parser.add_argument('--live', action='store_true', help='Enable live trading (use real money)')
